...
public class MyServiceImpl implements MyService {
    ...
    public ResponseVO dropLesson_clientA(String xml) throws DocumentException, SQLException {
        return myMapper.dropLesson_clientA(xml);
    }

    @Override
    public ResponseVO getChoosedLesson_clientA(String stuId) throws SQLException {
        return myMapper.getChoosedLesson_clientA(stuId);
    }

    @Override
    public ResponseVO chooseLesson_clientA(String xml) throws SQLException, DocumentException {
        return myMapper.chooseLesson_clientA(xml);
    }

    @Override
    public ResponseVO getShareLesson_clientA() throws SQLException {
        return myMapper.getShareLesson_clientA();
    }
