...
public interface MyMapper {
    ...
    ResponseVO dropLesson_clientA(String xml) throws DocumentException, SQLException;

    ResponseVO getChoosedLesson_clientA(String stuId) throws SQLException;

    ResponseVO chooseLesson_clientA(String xml) throws DocumentException, SQLException;

    ResponseVO getShareLesson_clientA() throws SQLException;
